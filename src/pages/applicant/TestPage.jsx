...
const ApplicantTestPage = () => {
  ...
  const renderPdfViewer = () => {
    ...
    return (
      <div className="bg-white rounded-lg border-2 border-gray-200 overflow-hidden">
        ...
        {numPages > 1 &&
          directPdfLink &&
          !directPdfLink.includes("drive.google.com") && (
      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Loading {quizData?.pdf_link ? "PDF test" : "questions"}...
          </p>
        </div>
      </div>
    );
          ...
          <div className="max-w-[1800px] mx-auto">
            <div className="mb-6">
              <Stack spacing={3}>
                ...
                >
                  Please review the PDF document below. When you're ready, click
                  the submit button to complete the test.
                </Typography>
              </Stack>
            </div>

            {/* PDF Viewer */}
            <div className="mb-8">{renderPdfViewer()}</div>
  ...
  const breadcrumbs = [
    ...
    <Typography
      key="2"
      sx={{ color: "#2E99B0", fontSize: { xs: 14, sm: 16, md: 18 } }}
    >
                  ...
                  <div className="flex-1 overflow-auto bg-gray-800 p-6">
                    {pdfError ? (
                      ...
                      <div className="flex justify-center">
                        {getDirectPdfLink(quizData.pdf_link) &&
                        getDirectPdfLink(quizData.pdf_link).includes(
                          "drive.google.com"
                        ) ? (
                          <div
                        ...
                        {currentQuestion.options.map((option) => {
                          ...
                          return (
                            <button
                              ...
                              onClick={() =>
                                handleAnswerSelect(option.answer_id)
                              }
